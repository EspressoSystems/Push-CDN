...
pub mod message {
  pub use self::Which::{AuthenticateWithKey,AuthenticateWithPermit,AuthenticateResponse,Direct,Broadcast,Subscribe,Unsubscribe,UserSync};
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_subscribe(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::enum_list::Owned<crate::messages_capnp::Topic>>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 5);
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_subscribe(self, size: u32) -> ::capnp::enum_list::Builder<'a,crate::messages_capnp::Topic> {
      self.builder.set_data_field::<u16>(0, 5);
    ...
    #[inline]
    pub fn set_unsubscribe(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::enum_list::Owned<crate::messages_capnp::Topic>>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 6);
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_unsubscribe(self, size: u32) -> ::capnp::enum_list::Builder<'a,crate::messages_capnp::Topic> {
      self.builder.set_data_field::<u16>(0, 6);
      ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), size)
    }
    #[inline]
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 155] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(221, 0, 0, 0, 186, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(233, 0, 0, 0, 170, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        ...
        5 => <::capnp::enum_list::Owned<crate::messages_capnp::Topic> as ::capnp::introspect::Introspect>::introspect(),
        6 => <::capnp::enum_list::Owned<crate::messages_capnp::Topic> as ::capnp::introspect::Introspect>::introspect(),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[2,0,1,4,3,5,6,7];
...
impl ::capnp::introspect::Introspect for Topic {
  fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema { encoded_node: &topic::ENCODED_NODE, annotation_types: topic::get_annotation_types }).into() }
}
impl <'a> ::core::convert::From<Topic> for ::capnp::dynamic_value::Reader<'a> {
  fn from(e: Topic) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema { encoded_node: &topic::ENCODED_NODE, annotation_types: topic::get_annotation_types }.into()).into() }
}
impl ::core::convert::TryFrom<u16> for Topic {
  type Error = ::capnp::NotInSchema;
  fn try_from(value: u16) -> ::core::result::Result<Self, <Topic as ::core::convert::TryFrom<u16>>::Error> {
    match value {
...
impl From<Topic> for u16 {
  #[inline]
  fn from(x: Topic) -> u16 { x as u16 }
}
impl ::capnp::traits::HasTypeId for Topic {
...
pub mod authenticate_with_key {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 67] = [
      ...
      ::capnp::word(97, 116, 101, 87, 105, 116, 104, 75),
...
pub mod authenticate_with_permit {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 34] = [
      ...
      ::capnp::word(46, 99, 97, 112, 110, 112, 58, 65),
      ::capnp::word(117, 116, 104, 101, 110, 116, 105, 99),
      ::capnp::word(97, 116, 101, 87, 105, 116, 104, 80),
      ::capnp::word(101, 114, 109, 105, 116, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
...
pub mod authenticate_response {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 49] = [
      ...
      ::capnp::word(46, 99, 97, 112, 110, 112, 58, 65),
      ::capnp::word(117, 116, 104, 101, 110, 116, 105, 99),
      ::capnp::word(97, 116, 101, 82, 101, 115, 112, 111),
...
pub mod direct {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 48] = [
      ...
      ::capnp::word(105, 114, 101, 99, 116, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(8, 0, 0, 0, 3, 0, 4, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 1, 0, 0, 0, 0, 0),
...
pub mod broadcast {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_topics(self) -> ::capnp::Result<::capnp::enum_list::Reader<'a,crate::messages_capnp::Topic>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_topics(self) -> ::capnp::Result<::capnp::enum_list::Builder<'a,crate::messages_capnp::Topic>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_topics(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::enum_list::Owned<crate::messages_capnp::Topic>>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_topics(self, size: u32) -> ::capnp::enum_list::Builder<'a,crate::messages_capnp::Topic> {
      ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), size)
    }
    #[inline]
    pub fn has_topics(&self) -> bool {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 52] = [
      ...
      ::capnp::word(114, 111, 97, 100, 99, 97, 115, 116),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(8, 0, 0, 0, 3, 0, 4, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <::capnp::enum_list::Owned<crate::messages_capnp::Topic> as ::capnp::introspect::Introspect>::introspect(),
        1 => <::capnp::data::Owned as ::capnp::introspect::Introspect>::introspect(),
        _ => panic!("invalid field index {}", index),
      }
    }
