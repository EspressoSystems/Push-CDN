...
impl<UserDef: Def> UserAuth<UserDef> {
    ...
    pub async fn authenticate_with_marshal(
        ...
        let signature = bail!(
            UserDef::SignatureScheme::sign(&keypair.private_key, &timestamp.to_le_bytes()),
            Crypto,
